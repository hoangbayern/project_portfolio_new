          ...
          >
            ...
            >
              ...
              <div className="flex flex-col items-center gap-7">
                <ul className="flex justify-center items-center flex-col text-base gap-7 w-full">

                  {links.map((link)=> (
                    <Link key={link.id}
                    className="flex items-center gap-1 font-medium text-textDark hover:text-textGreen
                     cursor-pointer duration-300 nav-link bg-black/[0.7] px-3 py-4 rounded-full w-full"
                    href={link.hash}
                    onClick={handleScroll}
                  >
                    <motion.li
