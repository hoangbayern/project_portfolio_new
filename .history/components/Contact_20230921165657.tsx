  ...
  return (
    ...
    >
      ...
      <p className="max-w-[600px] text-center text-textDark">
        ...
        ></textarea> */}
        <FormGroup className="bg-inherit text-white">
        <AdminInput className="!text-white"
          ...
          onChange={(e) => {
            ...
            setErrorName(e.target.value.length > 20 ? 'ニックネームは20文字以内で入力してください。' : null);
          }}
          type="text"
          placeholder="Your name"
          helperText={errorName || ''}
          sx={{ marginTop: '10px' , borderRadius: '10px', width: '38rem',height: '3rem' , outline: 'none', color: 'white !important', fontWeight: '700' }}
        />
      </FormGroup>
      <FormGroup>
        <AdminInput
