    ...
    >
      ...
      <VerticalTimeline>
        {experiencesData.map((experience) => (
          ...
          >
            <h4 className="vertical-timeline-element-title text-xl font-titleFont font-semibold tracking-wider">
              {experience.title}
            </h4>
            <h3 className="vertical-timeline-element-subtitle">{experience.location}</h3>
            <p>
